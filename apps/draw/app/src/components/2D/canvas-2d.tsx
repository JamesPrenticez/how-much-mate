...
// } from '@draw/stores';
// import { ElementType, type CadElement } from '@draw/models';
...
//   const { entities, addEntity } = useEntitiesStore(); // TODO
//   const [tempLine, setTempLine] = useState<CadElement | null>(null);
